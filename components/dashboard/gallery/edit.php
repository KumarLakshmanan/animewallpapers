...
?>
        ...
        <div class="row">
            <div class="col-md-6">
                <h6>Gallery Title *</h6>
                <div class="p-2">
                    <input type="text" class="form-control" id="title" placeholder="Enter Gallery name" required value="<?php echo ($propertyEdit[0]['name']); ?>">
                </div>
            </div>
            <div class="col-12">
                <h6>Gallery Description</h6>
                <div class="p-2">
                    <textarea rows="5" class="form-control texteditor-content" id="description" placeholder="Enter Gallery description" required><?php echo ($propertyEdit[0]['description']); ?></textarea>
                </div>
            </div>
                ...
                if (title == "") {
                    ...
                    swal({
                        ...
                        if (willDelete) {
                            ...
                            formData.append("mode", "editgallery");
