...
if ($_SESSION['role'] == "admin") {
    ...
    $sql = "SELECT * FROM news WHERE department = '" . $_SESSION['id'] . "' ORDER BY id DESC";
}
...
<div class="row">
    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
        <div class="white-box">
            <div class="text-end">
                <a href="<?= $adminBaseUrl ?>addnews" class="btn btn-success text-white">
    ...
    <div class="col-md-12 col-lg-12 col-sm-12">
        <div class="white-box">
            <div class="d-md-flex mb-3">
                <h3 class="box-title mb-0">All News</h3>
            </div>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?= $adminBaseUrl ?>editnews?newsid=<?= $value['id'] ?>" class="btn btn-info">
