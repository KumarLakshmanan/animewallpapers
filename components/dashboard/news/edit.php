...
?>
        ...
        <div class="row">
            <div class="col-md-6">
                <h6>News Title *</h6>
                <div class="p-2">
                    <input type="text" class="form-control" id="title" placeholder="Enter News name" required value="<?php echo ($propertyEdit[0]['name']); ?>">
                </div>
            </div>
            <div class="col-md-6">
                <h6>News Link</h6>
                <div class="p-2">
                    <input type="text" class="form-control" id="link" placeholder="Enter News link" value="<?php echo ($propertyEdit[0]['link']); ?>">
                </div>
            </div>
            <div class="col-md-6">
                <h6>News for</h6>
                <div class="p-2">
                    <select class="form-select" id="department" aria-label="Default select example">
                        <option value="common" data-name="Common" <?php if ($propertyEdit[0]['department'] == 'common') {
                                                                        echo "selected";
                                                                    } ?>>Common</option>
                        <?php
                        ...
                        ?>
                            <option value="<?= $department['id'] ?>" <?php if ($propertyEdit[0]['department'] == $department['id']) {
                                                                            echo "selected";
                                                                        } ?> data-name="<?= $department['fullname'] ?>"><?= $department['fullname'] ?></option>
                        <?php
                        }
                        ?>
                    </select>
            ...
            <div class="col-12">
                ...
                <div class="p-2">
                    <textarea rows="5" class="form-control texteditor-content" id="description" placeholder="Enter News description" required><?php echo ($propertyEdit[0]['description']); ?></textarea>
                </div>
            </div>
            <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                <div class="p-2">
                    <label for="images">News Image</label>
